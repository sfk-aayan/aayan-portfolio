    ...
    >
      <div className="max-w-6xl mx-auto flex items-center justify-between pointer-events-auto bg-[#070708]/75 backdrop-blur-md border border-zinc-800/60 px-5 py-3 rounded clip-tech-sm glow-cyan">
        ...
        <div className="flex items-center space-x-3 text-[10px] tracking-[0.25em] font-mono text-zinc-500">
          ...
          <span className="text-zinc-200 font-semibold tracking-widest font-display">FOUNDER_OPERATOR</span>
          <span className="hidden sm:inline-block text-zinc-700 border-l border-zinc-800 pl-3 font-mono">SYS_BUILD_v4.2</span>
        </div>
        ...
        <div className="flex items-center space-x-6 md:space-x-8 text-[9px] tracking-[0.25em] font-mono text-zinc-400">
          <div className="hidden md:flex items-center space-x-1.5">
            ...
            <span>LATENCY: <span className="text-amber-500 font-semibold">140μs</span></span>
          </div>
          
          <div className="flex items-center space-x-1.5">
            <Shield size={10} className="text-emerald-500" />
            <span>STABILITY: <span className="text-emerald-500 font-semibold">99.98%</span></span>
          </div>

          <div className="hidden lg:block text-zinc-500">
            SYNC_TIME: <span className="text-zinc-400">{systemTime || '2026-05-24 20:03:52Z'}</span>
          </div>
        </div>
